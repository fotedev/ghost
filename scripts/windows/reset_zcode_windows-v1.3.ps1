# ZCode / Qoder Identity Reset v1.3
#
...
#   powershell -ExecutionPolicy Bypass -File reset_zcode_windows-v1.3.ps1
...
if (-not $zcodeIsAdmin) {
    $zcodeLogOut = "$env:TEMP\zcode_v1.3_result.log"
...
Write-Host "=== ZCode / Qoder Identity Reset v1.3 ===" -ForegroundColor Cyan
...
if ($failCount -gt 0) {
    Write-Host "ZCode/Qoder reset v1.3 completed with failures. Review $auditPath." -ForegroundColor Red
    exit 1
}

Write-Host "ZCode/Qoder reset v1.3 completed successfully." -ForegroundColor Green
